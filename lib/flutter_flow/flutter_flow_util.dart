...
T? castToType<T>(dynamic value) {
  ...
  try {
    ...
    debugPrint('Safe cast failed for value: \$value of type \${value.runtimeType} to target type \$T');
    return null;
  }
}
