...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : const SplashScreenWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: AcceptedOrderlistWidget.routeName,
          path: AcceptedOrderlistWidget.routePath,
          builder: (context, params) => const AcceptedOrderlistWidget(),
        )
