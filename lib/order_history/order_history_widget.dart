...
class _OrderHistoryWidgetState extends State<OrderHistoryWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.loading = true;
      safeSetState(() {});
      _model.orderHistory = await GetOrderHISTORYCall.call(
      ...
      FFAppState().OrderHistory = OrderHistoryStruct.maybeFromMap(
              (_model.orderHistory?.jsonBody ?? ''))!
          .completedOrders
          .toList()
          .cast<CompletedOrdersStruct>();
      safeSetState(() {});
                          ...
                          child: Builder(
                            builder: (context) {
                              final orderHistoryList =
                                  FFAppState().OrderHistory.toList();
                            ...
                            return Column(
                              ...
                              children: List.generate(orderHistoryList.length,
                                      (orderHistoryListIndex) {
                                final orderHistoryListItem =
                                    orderHistoryList[orderHistoryListIndex];
                                return Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 10.0, 0.0, 0.0),
                                  child: Material(
                                                                        ...
                                                                        Flexible(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Text(
                                                                                orderHistoryListItem.firstName,
